...
3. **스케줄링**
   ...
   > 게시글 삭제 요청 후 15일 이 지난 게시글을 DB에서 삭제하도록 구현했으며, Redis를 사용해 메모리에 저장 및 수정된 게시글 데이터를 DB에 주기적으로 업데이트 하여 데이터 정합성을 보장하도록 구현했습니다.

   ![Myblog_Scheduler](https://github.com/gusm96/myblog-boot/assets/77833389/c40f8c78-1953-484e-bebf-2cb38b9effae)
